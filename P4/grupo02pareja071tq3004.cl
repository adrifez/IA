(defpackage :grupo02pareja071tq3004 ; se declara un paquete lisp que usa common-lisp
  (:use :common-lisp :mancala)      ; y mancala, y exporta la función de evaluación
  (:export :heuristica :*alias*))   ; heurística y un alias para el torneo

(in-package grupo02pareja071tq3004)
    ...
    (let ((f1 (get-fichas (estado-tablero estado) 
      ...
      (cond
       ...
       ((and (juego-terminado-p estado) 
        ...
        (- 95534))
       (T (apply #'+ (mapcar #'* 
                       '(-288 73 37 -119 -411 -320 -294 280 -389 48 120 303 -102 -154 -453 150)                       (list
                        f1
                        f2
                        f3
                        f4
...
(defvar *alias* '|THE_REAL_MRPOOPYBUTTHOLE|) ; alias que aparecerá en el ranking
