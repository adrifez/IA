(defpackage :grupo02pareja073tq3004 ; se declara un paquete lisp que usa common-lisp
  (:use :common-lisp :mancala)      ; y mancala, y exporta la función de evaluación
  (:export :heuristica :*alias*))   ; heurística y un alias para el torneo

(in-package grupo02pareja073tq3004)
...
(defvar *alias* '|THE_REAL_JERRY|) ; alias que aparecerá en el ranking
