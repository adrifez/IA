(defpackage :grupo02pareja071tq2404 ; se declara un paquete lisp que usa common-lisp
  (:use :common-lisp :mancala)      ; y mancala, y exporta la función de evaluación
  (:export :heuristica :*alias*))   ; heurística y un alias para el torneo

(in-package grupo02pareja071tq2404)
...
(defvar *alias* '|MR_POOPY|) ; alias que aparecerá en el ranking
